...
set gdbwks=C:\Users\hjkristenson\PycharmProjects\hyp3-nasa-disasters\image_server\asf_services\MD\CandB\vv_coh12_220930C.gdb
set outcrf=C:\Users\ASF\Documents\COVID19\Disasters\FloodAreas\NASA_Disasters_AWS.acs\esri\CandB_vv_coh12_220930C.crf
...
%ppath% %mdcspath%\scripts\MDCS.py -i:%mdcspath%\Parameter\Config\cb_vv_coh12_ovr.xml -m:%gdbwks%\vv_coh12 -s:%outcrf% -c:SE+CRA+AR+UpdateOverviewFields -p:%outcrf%$outcrf
