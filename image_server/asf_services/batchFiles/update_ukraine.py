...
batfile_rgb = 'Ukraine_rgb.bat'
batfile_rtc = 'Ukraine_rtc.bat'
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Ukraine_WM", None, aid_wm, "Dedicated Instance",
                 "**TEST OF WATERMAP EXTENT PRODUCT IN A REGION OTHER THAN WHERE IT WAS VALIDATED** "
                 "Watermap Extent products generated from Sentinel-1 SAR imagery over Ukraine, generated by ASF."
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Ukraine_RGB", None, aid_rgb, "Dedicated Instance",
                 "Sentinel-1 RGB Decomposition of RTC VV and VH imagery over Ukraine, processed by ASF. "
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Ukraine_RTC", None, aid_rtc, "Dedicated Instance",
                 "Radiometric Terrain Corrected (RTC) products generated from Sentinel-1 SAR imagery over Ukraine, "
                 "processed by ASF. Surface water appears very dark under calm conditions, as signal bounces off the "
