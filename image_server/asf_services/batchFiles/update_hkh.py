...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Combined_HKH_RGB", None, aid_rgb, "Dedicated Instance",
                 ...
                 "imagery over the Hindu Kush Himalayan (HKH) region for the 2021 monsoon season, starting "
                 "May 16, 2021. Blue areas have low returns in VV and VH (smooth surfaces such as calm water, "
                 ...
                 "Imagery products processed by ASF DAAC HyP3 2021 using GAMMA software. Contains modified "
