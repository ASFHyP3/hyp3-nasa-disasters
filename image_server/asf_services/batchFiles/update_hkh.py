...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "HKH", "None", "HKH_Watermap_Extent", None, aid_wm,
                 "Dedicated Instance", "Watermap Extent products generated from Sentinel-1 SAR imagery over "
                 "flood-prone regions in the Hindu Kush Himalayan (HKH) region for the 2021 monsoon season, "
                 "generated by ASF.", "Imagery products processed by ASF DAAC HyP3 2021 using GAMMA software. "
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "HKH", "None", "HKH_RGB", None, aid_rgb, "Dedicated Instance",
                 "Sentinel-1 RGB Decomposition of RTC VV and VH imagery over the Hindu Kush Himalayan (HKH) region "
                 "for the 2021 monsoon season, starting May 16, 2021. Blue areas have low returns in VV and VH "
                 "(smooth surfaces such as calm water, but also frozen/crusted soil or dry sand), Green areas have "
                 "high returns in VH (volume scatterers such as vegetation or some types of snow/ice), and Red areas "
                 "have relatively high VV returns and relatively low VH returns (such as urban or sparsely vegetated "
                 "areas).", "Imagery products processed by ASF DAAC HyP3 2021 using GAMMA software. Contains modified "
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "HKH", "None", "HKH_RTC", None, aid_rtc, "Dedicated Instance",
                 "Radiometric Terrain Corrected (RTC) products generated from Sentinel-1 SAR imagery over flood-prone "
                 "regions in the Hindu Kush Himalayan (HKH) region for the 2021 monsoon season, processed by ASF.",
                 "RTC products processed by ASF DAAC HyP3 2021 using GAMMA software. Contains modified Copernicus "
                 "Sentinel data 2021, processed by ESA.", '', False, False, True, None, None, None, None)
