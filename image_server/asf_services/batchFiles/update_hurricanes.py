...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Combined_CONUS_WM", None, aid_wm, "Dedicated Instance",
                 "**TEST OF COMBINED PUBLICATION DIRECTORY** Watermap Extent products generated from Sentinel-1 SAR "
                 "imagery over eastern CONUS for the 2021 hurricane season, generated by ASF.",
                 "Imagery products processed by ASF DAAC HyP3 2021 using "
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Combined_CONUS_RGB", None, aid_rgb, "Dedicated Instance",
                 "**TEST OF COMBINED PUBLICATION DIRECTORY** Sentinel-1 RGB Decomposition of RTC VV and VH imagery "
                 "over eastern CONUS for the 2021 hurricane season, processed by ASF. "
...
arcpy.AID.MAIDIS("asf-daac", "Update Service", "test", "None", "Combined_CONUS_RTC", None, aid_rtc, "Dedicated Instance",
                 "**TEST OF COMBINED PUBLICATION DIRECTORY** Radiometric Terrain Corrected (RTC) products generated "
                 "from Sentinel-1 SAR imagery over eastern CONUS for the 2021 hurricane season, processed by ASF. "
                 ...
                 "RTC products processed by ASF DAAC HyP3 2021 using GAMMA software. "
